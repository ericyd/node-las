...
module.exports = {
  ...
  pointDataRecordFormat0: {
    ...
    returnNumber: ['bitfield', 3], // 3 bits (bits 0 – 2) - 3 bits - [*]
    numberOfReturnsGivenPulse: ['bitfield', 3], // 3 bits (bits 3 – 5) - 3 bits - [*]
    scanDirectionFlag: ['bitfield', 1], // 1 bit (bit 6) - 1 bit - [*]
    edgeOfFlightLine: ['bitfield', 1], // 1 bit (bit 7) - 1 bit - [*]
  ...
  pointDataRecordFormat6: {
    ...
    z: 'int32', // long - 4 bytes - [*]
    intensity: 'uint16', // unsigned short - 2 bytes
    returnNumber: ['bitfield', 4], // 4 bits (bits 0 – 3) - 4 bits - [*]
    numberOfReturnsGivenPulse: ['bitfield', 4], // 4 bits (bits 4 – 7) - 4 bits - [*]
    classificationFlags: ['bitfield', 4], // 4 bits (bits 0 - 3)
    scannerChannel: ['bitfield', 2], // 2 bits (bist 4 - 5) - [*]
    scanDirectionFlag: ['bitfield', 1], // 1 bit (bit 6) - 1 bit - [*]
    edgeOfFlightLine: ['bitfield', 1], // 1 bit (bit 7) - 1 bit - [*]
    classification: 'uint8', // unsigned char - 1 byte - [*]
    userData: 'uint8', // unsigned char - 1 byte
