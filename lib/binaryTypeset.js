...
module.exports = {
  ...
  variableLengthRecordTemplate: jBinary.Template({
    ...
    setParams: function(vlrheader) {
      const header = {
        reserved: ['skip', 2],
        userId: vlrheader.userId,
        recordId: vlrheader.recordId,
        recordLengthAfterHeader: vlrheader.recordLengthAfterHeader,
        description: vlrheader.description
      };
      this.baseType = [
        'extend',
        header,
        ['bitfield', vlrheader.recordLengthAfterHeader * 8]
      ];
    },
    read: function() {
  ...
  LAS: [
    'object',
    {
      ...
      // each VLR has a VLR Header, followed by other data of length "vlrRecordLengthAfterHeader"
        ...
        read: function(header) {
          return this.binary.seek(header.headerSize, function() {
            ...
            const VLR = [
              ...
              vlrheader,
              {
                data: ['bitfield', vlrHeaderValues.recordLengthAfterHeader * 8]
              }
            ];
